...
function checkResults(){
	...
	for (let i = 0; i<maxAufgaben;i++){
		a = parseInt(document.getElementById('sum1_'+i).textContent);
		b = parseInt(document.getElementById('sum2_'+i).textContent);
		c = parseInt(document.getElementsByClassName('loesung')[i].value);
		...
		console.log(document.getElementById('sum1_'+i).textContent)
		console.log(document.getElementById('sum2_'+i).textContent)
